...
//PRESENTATION LAYER FOR CATEGORY:
@Controller
public class CategoryController {
    ...
    private CategoryService categoryService;
       ...
       //GETTING LIST OF CATEGORIES AND DISPLAYING IT ON UI:
    ...
    // SUBMIT/SAVE CHANGES (of the updated category):
